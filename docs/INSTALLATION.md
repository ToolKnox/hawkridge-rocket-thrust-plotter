...
1. Download the printable files from Printables: https://www.printables.com/model/1776632-rocket-thrust-plotter
2. Download this GitHub repository as a ZIP, or clone it:

   ```bash
   git clone https://github.com/ToolKnox/hawkridge-rocket-thrust-plotter.git
   ```
